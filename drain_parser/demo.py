...
input_dir  = '../datasets/TH_20G_ratio/' # The input directory of log file
output_dir = '../datasets/TH_20G_ratio/'  # The output directory of parsing results
log_file   = 'TH_20G_ratio.log'  # The input log file name
