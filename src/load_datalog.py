...
#            exit()
        ...
        elif dataset == 'TH_1G_ratio' or dataset == 'TH_2G_ratio' or dataset == 'TH_3G_ratio' or dataset == 'TH_5G_ratio' or dataset == 'TH_6G_ratio' or dataset == 'TH_9G_ratio' or dataset == 'TH_12G_ratio' or dataset == 'TH_20G_ratio':
            #  Define dtype mapping for efficient memory usage
            dtype_mapping = {"User": "str", "EventTemplate": "category", "Content": "str", "Date": "str", "Time": "str",
                             "Component": "category", "EventId": "str", "Label": "category"}
