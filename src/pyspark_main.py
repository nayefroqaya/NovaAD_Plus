...
num_workers = 1    # defualt =8
cores_per_worker =1   # defaul =4  # cores_per_worker = spark_cores // num_workers
executor_memory_gb =1 # executor_memory_gb = spark_ram_gb // num_workers
