...
def main():
    ...
    #output_path = "gs://sparkadls/Nova_Plus/datasets/TH_3G_ratio/1_TH_3G_ratio_Topic_sentiment_diff_semantic_df.parquet"  # for cloud
    ...
    final_train_with_test_with_val = repeat_df(final_train_with_test_with_val, 100)
