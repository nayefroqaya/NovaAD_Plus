...
class Utilities:
    ...
    def dataset_splitting(all_data_df, dataset, round, Mix_or_stable, spark):
        ...
        supported = {'HDFS','BGL','HDO','SP_100MB','SP_150MB','SP_100MB_ratio','SP_150MB_ratio','TH_1G', 'TH_1G_ratio','TH_2G','TH_2G_ratio', 'TH_3G_ratio','TH_5G','TH_5G_ratio', 'TH_6G_ratio','TH_Full','TH_9G_ratio','TH_12G_ratio','TH_16G_ratio','TH_20G_ratio','S_BGL'}
